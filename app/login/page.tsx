...
export default function LoginPage() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-white dark:bg-black px-4">
      ...
      >
        <h2 className="text-2xl font-bold text-center text-pink-600">Connexion à AvisAI</h2>
        ...
        <form className="space-y-4">
          ...
          <div className="flex items-center justify-between text-sm">
            <Link href="/forgot" className="text-pink-500 hover:underline">Mot de passe oublié ?</Link>
            <Link href="/register" className="text-zinc-500 dark:text-zinc-400 hover:underline">Créer un compte</Link>
          </div>

          <button type="submit"
            className="w-full bg-pink-500 hover:bg-pink-600 text-white font-medium py-2 rounded-lg transition">Se connecter</button>
        </form>
