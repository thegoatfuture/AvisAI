    ...
    <main className="min-h-screen flex items-center justify-center bg-white dark:bg-black px-4">
      ...
      >
        ...
        <form className="space-y-4">
          ...
          <button type="submit"
            className="w-full bg-pink-500 hover:bg-pink-600 text-white font-medium py-2 rounded-lg transition">Créer un compte</button>
        </form>
        ...
        <div className="text-center text-sm pt-2">
          <Link href="/login" className="text-pink-500 hover:underline">Vous avez déjà un compte ? Connectez-vous</Link>
        </div>
      </motion.div>
    </main>
  );
